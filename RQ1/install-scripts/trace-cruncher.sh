...
git clone https://github.com/vmware-archive/trace-cruncher.git
cd trace-cruncher
git checkout 9826ee8451894f5ea4e3ce2395b7e0f69f76d5f6
...
# Fix Cython version for build
pip install Cython==0.29.37

cd /tmp/rq1-build/trace-cruncher/trace-cruncher
make
make install

pip install --no-build-isolation -t /pyxray/data/install/trace-cruncher___RQ1 .
pip install --no-build-isolation -t /pyxray/data/install/trace-cruncher___RQ1___TOPLEVEL --no-deps .

pip install --upgrade cython
rm -rf /tmp/rq1-build/trace-cruncher
